...
sealed class MyCheckInListScreenUiEvent {
    ...
    data class OnClickChangePrivacy(val item: CheckInEntity, val privacy: CheckInPrivacy) :
        MyCheckInListScreenUiEvent()
    data class OnClickDelete(val item: CheckInEntity) : MyCheckInListScreenUiEvent()
    data class OnChangePrivacy(val item: CheckInEntity, val privacy: CheckInPrivacy) :
        MyCheckInListScreenUiEvent()
