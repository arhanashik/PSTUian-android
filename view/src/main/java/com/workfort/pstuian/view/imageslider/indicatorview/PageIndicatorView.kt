...
import com.workfort.pstuian.view.imageslider.indicatorview.draw.data.PositionSavedState
import com.workfort.pstuian.view.imageslider.indicatorview.draw.data.RtlMode
import com.workfort.pstuian.view.imageslider.indicatorview.utils.CoordinatesUtils.getProgress
import com.workfort.pstuian.view.imageslider.indicatorview.utils.DensityUtils.dpToPx
import com.workfort.pstuian.view.imageslider.indicatorview.utils.IdUtils
...
class PageIndicatorView @JvmOverloads constructor(
    ...
    private fun findViewPager(viewGroup: ViewGroup, id: Int): SliderPager? {
        ...
        val view = viewGroup.findViewById(id)
