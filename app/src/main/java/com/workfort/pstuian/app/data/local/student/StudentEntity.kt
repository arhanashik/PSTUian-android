...
data class StudentEntity(
    ...
    @ColumnInfo(name = ColumnNames.Student.REG) var reg: String,
    @ColumnInfo(name = ColumnNames.Student.PHONE) var phone: String?,
    ...
    var fbLink: String?,
    @ColumnInfo(name = ColumnNames.Student.BLOOD) var blood: String?,
    @ColumnInfo(name = ColumnNames.Student.ADDRESS) var address: String?,
    @ColumnInfo(name = ColumnNames.Student.EMAIL) var email: String?,
    @SerializedName("batch_id")
    @ColumnInfo(name = ColumnNames.Student.BATCH_ID)
    var batchId: Int,
    @ColumnInfo(name = ColumnNames.Student.SESSION) var session: String,
