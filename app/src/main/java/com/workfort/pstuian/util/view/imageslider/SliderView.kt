...
import com.workfort.pstuian.util.view.imageslider.SliderViewAdapter.DataSetListener
...
import com.workfort.pstuian.util.view.imageslider.indicatorview.draw.controller.AttributeController.Companion.getRtlMode
...
class SliderView @JvmOverloads constructor(
    ...
    DataSetListener, SliderPager.OnPageChangeListener {
    companion object {
    ...
    private var mSliderPager: SliderPager = SliderPager(context).apply {
    ...
    private fun getAdapterItemsCount(): Int {
        if(getSliderAdapter() == null) {
            Timber.e("getAdapterItemsCount: Slider Adapter is null so, " +
