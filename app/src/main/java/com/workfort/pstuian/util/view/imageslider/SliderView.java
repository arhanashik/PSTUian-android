...
import com.workfort.pstuian.util.view.imageslider.indicatorview.PageIndicatorView;
import com.workfort.pstuian.util.view.imageslider.indicatorview.animation.type.BaseAnimation;
import com.workfort.pstuian.util.view.imageslider.indicatorview.animation.type.ColorAnimation;
...
import com.workfort.pstuian.util.view.imageslider.indicatorview.utils.DensityUtils;
import com.workfort.pstuian.util.view.imageslider.infiniteadapter.InfinitePagerAdapter;
import com.workfort.pstuian.util.view.imageslider.transformations.*;
import com.workfort.pstuian.util.view.imageslider.transformations.DepthTransformation;
...
public class SliderView extends FrameLayout
    ...
    private void setUpAttributes(@NonNull Context context, AttributeSet attrs) {
        ...
        if (mIsIndicatorEnabled) {
            ...
            int indicatorRadius = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorRadius, DensityUtils.INSTANCE.dpToPx(2));
            int indicatorPadding = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorPadding, DensityUtils.INSTANCE.dpToPx(3));
            int indicatorMargin = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorMargin, DensityUtils.INSTANCE.dpToPx(12));
            int indicatorMarginLeft = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorMarginLeft, DensityUtils.INSTANCE.dpToPx(12));
            int indicatorMarginTop = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorMarginTop, DensityUtils.INSTANCE.dpToPx(12));
            int indicatorMarginRight = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorMarginRight, DensityUtils.INSTANCE.dpToPx(12));
            int indicatorMarginBottom = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorMarginBottom, DensityUtils.INSTANCE.dpToPx(12));
            ...
            RtlMode rtlMode = AttributeController.Companion.getRtlMode(indicatorRtlMode);
    ...
    public void setSliderTransformAnimation(SliderAnimations animation) {
        ...
        switch (animation) {
            ...
            case CLOCK_SPINTRANSFORMATION:
                mSliderPager.setPageTransformer(false, new ClockSpinTransformation());
                break;
