package com.workfort.pstuian.app.ui.common.ui.blooddonationrequestcreate
...
sealed class BloodDonationRequestCreateScreenUiEvent {
    ...
    data class OnChangeInput(val input: BloodDonationRequestInput) : BloodDonationRequestCreateScreenUiEvent()
