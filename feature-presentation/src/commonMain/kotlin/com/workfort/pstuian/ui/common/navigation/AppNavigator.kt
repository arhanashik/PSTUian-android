...
class AppNavigator {
    ...
    suspend fun navigateToBloodDonationInput(donationId: Int?, userId: Int, userType: UserType) =
        navigateTo(AppScreen.BloodDonationInput(donationId, userId, userType))
