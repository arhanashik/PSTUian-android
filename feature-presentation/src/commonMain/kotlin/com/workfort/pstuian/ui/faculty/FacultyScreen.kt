...
import com.workfort.pstuian.ui.faculty.composable.FacultyContentPanel
...
@Composable
internal fun FacultyScreen(viewModel: FacultyViewModel) {
...
private fun FacultyScreenContent(
    ...
    AppScaffold(
        ...
        FacultyContentPanel(uiState, onUiEvent)
    }
}
