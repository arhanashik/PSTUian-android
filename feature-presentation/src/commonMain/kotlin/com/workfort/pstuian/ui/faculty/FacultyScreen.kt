package com.workfort.pstuian.app.ui.common.ui.faculty
...
import com.workfort.pstuian.reducer.ui.faculty.FacultyScreenState
...
import com.workfort.pstuian.common.component.ScrollableTabView
...
import pstuian.feature_presentation.generated.resources.label_batch
import pstuian.feature_presentation.generated.resources.label_teacher
import pstuian.feature_presentation.generated.resources.label_course_schedule
...
fun FacultyScreen(
    ...
    onBack: () -> Unit,
    navigateToStudents: (BatchEntity) -> Unit,
    navigateToTeacher: (TeacherEntity) -> Unit,
    navigateToEmployee: (EmployeeEntity) -> Unit,
    onCall: (String) -> Unit,
) {
    ...
    with(uiEvent) {
        when (this) {
            ...
            is FacultyScreenUiEvent.OnCall -> onCall(phoneNumber)
...
private fun FacultyScreenContent(
    ...
    val tabs = listOf(
        stringResource(Res.string.label_batch),
        stringResource(Res.string.label_teacher),
        stringResource(Res.string.label_course_schedule),
