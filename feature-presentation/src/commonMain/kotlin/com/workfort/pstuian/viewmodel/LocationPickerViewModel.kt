...
import com.workfort.pstuian.reducer.ui.common.locationpicker.LocationPickerScreenStateUpdate
...
class LocationPickerViewModel(
    ...
    fun search(query: String, refresh: Boolean) {
        ...
        viewModelScope.launch {
            runCatching {
                val locations = checkInLocationRepo.search(queryCache, checkInLocationPage).map {
                    it.toEntity()
                }
