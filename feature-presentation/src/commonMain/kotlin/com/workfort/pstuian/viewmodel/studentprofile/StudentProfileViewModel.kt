package com.workfort.pstuian.app.ui.commonmodel.studentprofile
...
import com.workfort.pstuian.reducer.ui.studentprofile.StudentProfileScreenStateUpdate
    ...
    fun onClickImage(url: String) {
        ...
        updateScreenState(
            StudentProfileScreenStateUpdate.NavigateTo(
                StudentProfileScreenState.NavigationState.ImagePreviewScreen(url),
            )
        )
    }
