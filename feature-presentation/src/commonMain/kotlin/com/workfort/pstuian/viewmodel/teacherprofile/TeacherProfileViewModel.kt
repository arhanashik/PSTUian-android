package com.workfort.pstuian.app.ui.commonmodel.teacherprofile
...
import com.workfort.pstuian.reducer.ui.teacherprofile.TeacherProfileScreenStateUpdate
    ...
    fun onClickImage(url: String) {
        ...
        updateScreenState(
            TeacherProfileScreenStateUpdate.NavigateTo(
                TeacherProfileScreenState.NavigationState.ImagePreviewScreen(url),
            )
        )
    }
