package com.workfort.pstuian.app.ui.commonmodel.teacherprofileedit
...
import com.workfort.pstuian.reducer.ui.teacherprofileedit.TeacherProfileEditScreenStateUpdate
...
class TeacherProfileEditViewModel(
    ...
    fun onClickFaculty() = newProfileCache?.teacher?.let { teacher ->
        updateScreenState(
            TeacherProfileEditScreenStateUpdate.NavigateTo(
