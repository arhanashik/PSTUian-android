package com.workfort.pstuian.app.ui.commonmodel.mydevicelist
...
import com.workfort.pstuian.reducer.ui.mydevicelist.MyDeviceListScreenStateUpdate
...
class MyDeviceListViewModel(
    ...
    private fun updateScreenState(update: MyDeviceListScreenStateUpdate) =
        _screenState.update { oldState -> update(oldState) }
