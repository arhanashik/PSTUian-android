...
import com.workfort.pstuian.model.dto.BloodDonationRequestDto
...
class BloodDonationRequestApiService(private val client: HttpClient) {
    suspend fun getAll(
        page: Int = 1,
        limit: Int = 20,
    ): Response<List<BloodDonationRequestDto>> {
    ...
    suspend fun get(id: Int): Response<BloodDonationRequestDto> {
    ...
    suspend fun insert(
        ...
        contact: String,
        info: String?,
    ): Response<BloodDonationRequestDto> {
